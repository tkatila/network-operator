...
# intel.com/intel-network-operator-bundle:$VERSION and intel.com/intel-network-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= intel.com/intel-network-operator
...
build: manifests generate fmt vet ## Build manager binary.
	...
	go build -o bin/discover cmd/discover/main.go
